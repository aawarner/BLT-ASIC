...
if __name__=='__main__':
    ...
    csv_sn_list=file_SN_search('/Users/aawarner/Desktop/Serial Number Roll Up.csv')
    #csv_sn_list=[]
    #print(str(len(csv_sn_list))+' is the number of SNs from the file.')
    webform_sn_list=[]
    raw_ccwr_output_csv='test.csv'
    sn_list=list(set(csv_sn_list+webform_sn_list))
    ...
    create_3K_lic_rpt(ccwr_full_list, '3Klicrpt-17DEC.csv', 'eucom.army.mil')
